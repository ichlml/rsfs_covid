<section class="section">
    <div class="section-header">
        <h1 class="text-center">DASHBOARD ISOLASI COVID-19 LANTAI 1</h1>
    </div>
    <div class="row">
            <?php 
                                    ...
                                    <div class="col-sm">
                                        ...
                                        ?>
                                                    ...
                                                    <?php }elseif($p->jk == 'L' and $p->status_pasien == 'confirm'){?>
                                                        <button id="det" data-target="#exampleModal" data-toggle="modal" data-nama="<?= $p->nm_pasien?>" data-almt="<?= $p->alamat?>"="disabled" class="btn btn-sm btn-info"><?= $p->jk ?></button>
                                                        <button disabled="disabled" class="btn btn-sm btn-success"><?= $p->status_pasien ?></button>
