<section class="section">
    <div class="section-header">
        <h1 class="text-center">DASHBOARD ISOLASI COVID-19 LANTAI 5</h1>
    </div>
    <div class="row">
            <?php 
                                    ...
                                    <div class="col-sm">
                                        ...
                                        ?>
                                                    <?php if($p->jk == 'P' and $p->status_pasien == 'suspect' and $p->status_plg == ''){ ?>
                                                        <button id="det" data-target="#exampleModal" data-toggle="modal" data-nama="<?= $p->nm_pasien?>" data-almt="<?= $p->alamat?>" class="btn btn-sm btn-pink"><?= $p->jk ?></button>
