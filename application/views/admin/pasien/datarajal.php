<section class="section">
    <div class="section-header">Pasien Covid19 Rawat Jalan </div>
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="card card-danger">
                    ...
                    <div class="card-body">
                        <form action="<?= base_url('pasien/addPasienRajal')?>" method="post">
                            ...
                            <div class="form-group">
                                <input type="hidden" name="jns_pr" id="jns_pr" class="form-control form-control-sm" value="rajal" readonly>
                            </div>
                            <div class="form-group">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php
                                            ...
                                            ?>
                                                <button id="upSuspect"  class="btn btn-secondary btn-block btn-sm" data-toggle ="modal"
                                                data-target="#ModalSuscpect"
                                                data-id="<?= $key->no_rkm_medis?>"
                                                data-idbed="<?= $key->id_bed?>"
                                                data-status_pasien="<?= $key->status_pasien?>">Probable</button>
                                            <?php
                                        ...
                                        <td>
                                                <button id="pindah" class="btn btn-sm btn-warning" title="Pidah Rawat Inap" data-toggle="modal" data-target="#PindahKamar"
                                                data-id="<?= $key->no_rkm_medis?>"
                                                data-idbed="<?= $key->id_bed?>"
                                                data-status_pasien="<?= $key->status_pasien?>"
                                                data-jk="<?= $key->jk?>"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= base_url('pasien/upPasienRajal')?>" method="post">
                    ...
                    <div id="puls">
                        ...
                        <select name="status_plg" id="status_plg" class="form-control">
                            ...
                            <option value="meninggal">Meninggal</option>
                            <option value="pulang aps">Pulang APS</option>
                            <option value="pulang blpc">Pulang Izin Dokter </option>
      ...
      <div class="modal-body">
        <form action="<?= base_url('pasien/pindahKamar')?>" method="post">
            ...
            <div class="form-group">
                ...
                <select name="id_kamar_upd" id="id_kamar_upd" class="form-control js-example-basic-single" >
            ...
            <div class="form-group">
                <label for="">BED</label>
                <select name="id_bed_upd" id="id_bed_upd" class="form-control js-example-basic-single">
